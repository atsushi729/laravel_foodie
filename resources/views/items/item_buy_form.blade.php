            ...
            <div class="row">
                <div class="col-8 offset-2">
                    ...
                    <div class="form-group mt-3">
                        <label for="number-form">カード番号（番号は4242424242424242を入力して下さい）</label>
                        <div id="number-form" class="form-control"><!-- ここにカード番号入力フォームが生成される --></div>
                    </div>
                    <div class="form-group mt-3">
                        <label for="expiry-form">有効期限（未来の年月を入力して下さい）</label>
                        <div id="expiry-form" class="form-control"><!-- ここに有効期限入力フォームが生成される --></div>
                    </div>
                    <div class="form-group mt-3">
                        <label for="expiry-form">セキュリティコード（任意の3文字を入力して下さい）</label>
                        <div id="cvc-form" class="form-control"><!-- ここにCVC入力フォームが生成される --></div>
                    </div>
                </div>
            </div>
